...
document.addEventListener('DOMContentLoaded', () => {
    ...
    yesBtn.addEventListener('click', () => {
        ...
        if (celebrationVideo) {
            ...
            celebrationVideo.currentTime = 0;  // reset video to start
    ...
    class ConfettiPiece {
        ...
        draw() {
            ...
            ctx.globalAlpha = confettiOpacity; // fade effect
    ...
    function startConfetti() {
        ...
        setTimeout(() => {
            ...
            const fadeInterval = setInterval(() => {
                confettiOpacity -= 0.02; // speed of fade
                if (confettiOpacity <= 0) {
                    ...
                    confettiOpacity = 1; // reset for next time
                }
            }, 50);
        }, 8000);
